...
for i_scenario = [1,1,2,2,1,1,3,3] %1 - no treatment, 2 - antiviral treatment, 3 - antiviral prophylaxis, 4 - antiviral treatment + prophylaxis
    ...
    if i_scenario == 1
        ...
        subplot(4,1,1);
        % rectangle('Position',[time_treat 0 max(tspan)-time_treat max(I_all)+0.1*max(I_all)],'FaceColor',[225,225,225]./255,'EdgeColor','none')
        xline(time_treat,':','Color','k')
        hold on
        plot(t,I_all,'-','Color',cmap_all(i_scenario,:),'LineWidth',LW)
        hold on

        subplot(4,1,2);
        % rectangle('Position',[time_treat 0 max(tspan)-time_treat max(Is_all)+0.1*max(Is_all)],'FaceColor',[225,225,225]./255,'EdgeColor','none')
        xline(time_treat,':','Color','k')
        hold on
        plot(t,Is_all,'-','Color',cmap_all(i_scenario,:),'LineWidth',LW)
        hold on
        ...
        subplot(4,1,3);
        xline(time_treat,':','Color','k')
        % rectangle('Position',[time_treat 0 max(tspan)-time_treat max(Ir_all)+0.1*max(Ir_all)],'FaceColor',[225,225,225]./255,'EdgeColor','none')
        hold on
        plot(t,Ir_all,'-','Color',cmap_all(i_scenario,:),'LineWidth',LW)
        hold on
        ...
        xline(time_treat,':','Color','k')
        % hold on
        % rectangle('Position',[time_treat 0 max(tspan)-time_treat max(Is_r_all)+0.1*max(Is_r_all)],'FaceColor',[225,225,225]./255,'EdgeColor','none')
        hold on
        plot(t,Is_r_all,'-','Color',cmap_all(i_scenario,:),'LineWidth',LW)
        hold on
...
T= T_mono([1:4,7,8],[1:4,6]);

figure
for j = 1:size(T,2)
    j_count = 0;
    subplot(size(T,2),1,j)
    for i = 1:size(T,1)
...
plot([0,T_mono(3,8)],[j_count,j_count],'-','Color',cmap_all(3,:),'LineWidth',3)
hold on
% scatter(T_mono(3,8),j_count,20,'filled','MarkerFaceColor','k','MarkerEdgeColor','none')
% hold on
j_count = j_count -1;
...
plot([0,T_mono(7,8)],[j_count,j_count],'-','Color',cmap_all(5,:),'LineWidth',3)
hold on
% scatter(T_mono(7,8),j_count,20,'filled','MarkerFaceColor','k','MarkerEdgeColor','none')
% hold on
j_count = j_count -1;

plot([0,T_mono(8,8)],[j_count,j_count],'-','Color',cmap_all(6,:),'LineWidth',3)
hold on
% scatter(T_mono(8,8),j_count,20,'filled','MarkerFaceColor','k','MarkerEdgeColor','none')
% hold on
j_count = j_count -1;
